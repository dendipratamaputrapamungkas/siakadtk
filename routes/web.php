...
Route::get('/spp/export', [PembayaranSppController::class, 'exportExcel'])
    ->name('spp.export');
    ...
    Route::post('/admin/pendaftaran/{id}/status', [PendaftaranController::class, 'updateStatus'])->name('pendaftaran.updateStatus');   